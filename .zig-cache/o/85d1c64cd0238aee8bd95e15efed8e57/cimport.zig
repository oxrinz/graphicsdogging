...
pub const struct__drmModeRes = extern struct {
    count_fbs: c_int = @import("std").mem.zeroes(c_int),
    fbs: [*c]u32 = @import("std").mem.zeroes([*c]u32),
    count_crtcs: c_int = @import("std").mem.zeroes(c_int),
    crtcs: [*c]u32 = @import("std").mem.zeroes([*c]u32),
    count_connectors: c_int = @import("std").mem.zeroes(c_int),
    connectors: [*c]u32 = @import("std").mem.zeroes([*c]u32),
    count_encoders: c_int = @import("std").mem.zeroes(c_int),
    encoders: [*c]u32 = @import("std").mem.zeroes([*c]u32),
...
pub const struct__drmModeModeInfo = extern struct {
    clock: u32 = @import("std").mem.zeroes(u32),
    hdisplay: u16 = @import("std").mem.zeroes(u16),
    hsync_start: u16 = @import("std").mem.zeroes(u16),
    hsync_end: u16 = @import("std").mem.zeroes(u16),
    htotal: u16 = @import("std").mem.zeroes(u16),
    hskew: u16 = @import("std").mem.zeroes(u16),
    vdisplay: u16 = @import("std").mem.zeroes(u16),
    vsync_start: u16 = @import("std").mem.zeroes(u16),
    vsync_end: u16 = @import("std").mem.zeroes(u16),
    vtotal: u16 = @import("std").mem.zeroes(u16),
    vscan: u16 = @import("std").mem.zeroes(u16),
    vrefresh: u32 = @import("std").mem.zeroes(u32),
...
pub const struct__drmModeFB2 = extern struct {
    ...
    width: u32 = @import("std").mem.zeroes(u32),
    height: u32 = @import("std").mem.zeroes(u32),
    pixel_format: u32 = @import("std").mem.zeroes(u32),
    modifier: u64 = @import("std").mem.zeroes(u64),
    flags: u32 = @import("std").mem.zeroes(u32),
    handles: [4]u32 = @import("std").mem.zeroes([4]u32),
    pitches: [4]u32 = @import("std").mem.zeroes([4]u32),
    offsets: [4]u32 = @import("std").mem.zeroes([4]u32),
};
...
pub const struct__drmModeProperty = extern struct {
    prop_id: u32 = @import("std").mem.zeroes(u32),
    flags: u32 = @import("std").mem.zeroes(u32),
    name: [32]u8 = @import("std").mem.zeroes([32]u8),
    count_values: c_int = @import("std").mem.zeroes(c_int),
    values: [*c]u64 = @import("std").mem.zeroes([*c]u64),
    count_enums: c_int = @import("std").mem.zeroes(c_int),
    enums: [*c]struct_drm_mode_property_enum = @import("std").mem.zeroes([*c]struct_drm_mode_property_enum),
    count_blobs: c_int = @import("std").mem.zeroes(c_int),
    blob_ids: [*c]u32 = @import("std").mem.zeroes([*c]u32),
};
...
pub const struct__drmModeCrtc = extern struct {
    crtc_id: u32 = @import("std").mem.zeroes(u32),
    buffer_id: u32 = @import("std").mem.zeroes(u32),
    x: u32 = @import("std").mem.zeroes(u32),
    y: u32 = @import("std").mem.zeroes(u32),
    width: u32 = @import("std").mem.zeroes(u32),
    height: u32 = @import("std").mem.zeroes(u32),
    mode_valid: c_int = @import("std").mem.zeroes(c_int),
    mode: drmModeModeInfo = @import("std").mem.zeroes(drmModeModeInfo),
    gamma_size: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const struct__drmModeEncoder = extern struct {
    encoder_id: u32 = @import("std").mem.zeroes(u32),
    encoder_type: u32 = @import("std").mem.zeroes(u32),
    crtc_id: u32 = @import("std").mem.zeroes(u32),
    possible_crtcs: u32 = @import("std").mem.zeroes(u32),
    possible_clones: u32 = @import("std").mem.zeroes(u32),
};
...
pub const struct__drmModeConnector = extern struct {
    connector_id: u32 = @import("std").mem.zeroes(u32),
    encoder_id: u32 = @import("std").mem.zeroes(u32),
    connector_type: u32 = @import("std").mem.zeroes(u32),
    connector_type_id: u32 = @import("std").mem.zeroes(u32),
    connection: drmModeConnection = @import("std").mem.zeroes(drmModeConnection),
    mmWidth: u32 = @import("std").mem.zeroes(u32),
    mmHeight: u32 = @import("std").mem.zeroes(u32),
    subpixel: drmModeSubPixel = @import("std").mem.zeroes(drmModeSubPixel),
    count_modes: c_int = @import("std").mem.zeroes(c_int),
    modes: drmModeModeInfoPtr = @import("std").mem.zeroes(drmModeModeInfoPtr),
    count_props: c_int = @import("std").mem.zeroes(c_int),
    props: [*c]u32 = @import("std").mem.zeroes([*c]u32),
    prop_values: [*c]u64 = @import("std").mem.zeroes([*c]u64),
    count_encoders: c_int = @import("std").mem.zeroes(c_int),
    encoders: [*c]u32 = @import("std").mem.zeroes([*c]u32),
};
...
pub const struct__drmModeObjectProperties = extern struct {
    count_props: u32 = @import("std").mem.zeroes(u32),
    props: [*c]u32 = @import("std").mem.zeroes([*c]u32),
    prop_values: [*c]u64 = @import("std").mem.zeroes([*c]u64),
};
...
pub const struct__drmModeFormatModifierIterator = extern struct {
    fmt_idx: u32 = @import("std").mem.zeroes(u32),
    mod_idx: u32 = @import("std").mem.zeroes(u32),
    fmt: u32 = @import("std").mem.zeroes(u32),
    mod: u64 = @import("std").mem.zeroes(u64),
};
...
pub const struct__drmModePlane = extern struct {
    count_formats: u32 = @import("std").mem.zeroes(u32),
    formats: [*c]u32 = @import("std").mem.zeroes([*c]u32),
    plane_id: u32 = @import("std").mem.zeroes(u32),
    crtc_id: u32 = @import("std").mem.zeroes(u32),
    fb_id: u32 = @import("std").mem.zeroes(u32),
    crtc_x: u32 = @import("std").mem.zeroes(u32),
    crtc_y: u32 = @import("std").mem.zeroes(u32),
    x: u32 = @import("std").mem.zeroes(u32),
    y: u32 = @import("std").mem.zeroes(u32),
    possible_crtcs: u32 = @import("std").mem.zeroes(u32),
    gamma_size: u32 = @import("std").mem.zeroes(u32),
};
...
pub const struct__drmModePlaneRes = extern struct {
    count_planes: u32 = @import("std").mem.zeroes(u32),
    planes: [*c]u32 = @import("std").mem.zeroes([*c]u32),
};
...
pub const struct_drmModeLesseeList = extern struct {
    count: u32 align(4) = @import("std").mem.zeroes(u32),
    pub fn lessees(self: anytype) @import("std").zig.c_translation.FlexibleArrayType(@TypeOf(self), c_uint) {
...
pub const struct_drmModeObjectList = extern struct {
    count: u32 align(4) = @import("std").mem.zeroes(u32),
    pub fn objects(self: anytype) @import("std").zig.c_translation.FlexibleArrayType(@TypeOf(self), c_uint) {
        const Intermediate = @import("std").zig.c_translation.FlexibleArrayType(@TypeOf(self), u8);
        const ReturnType = @import("std").zig.c_translation.FlexibleArrayType(@TypeOf(self), c_uint);
        return @as(ReturnType, @ptrCast(@alignCast(@as(Intermediate, @ptrCast(self)) + 4)));
    }
...
pub const struct_gbm_device = opaque {};
pub const struct_gbm_bo = opaque {};
pub const struct_gbm_surface = opaque {};
pub const union_gbm_bo_handle = extern union {
    ptr: ?*anyopaque,
    s32: i32,
    u32: u32,
    s64: i64,
...
pub const GBM_BO_FORMAT_XRGB8888: c_int = 0;
pub const GBM_BO_FORMAT_ARGB8888: c_int = 1;
pub const enum_gbm_bo_format = c_uint;
pub const struct_gbm_format_name_desc = extern struct {
    name: [5]u8 = @import("std").mem.zeroes([5]u8),
};
pub const GBM_BO_USE_SCANOUT: c_int = 1;
pub const GBM_BO_USE_CURSOR: c_int = 2;
pub const GBM_BO_USE_CURSOR_64X64: c_int = 2;
pub const GBM_BO_USE_RENDERING: c_int = 4;
pub const GBM_BO_USE_WRITE: c_int = 8;
pub const GBM_BO_USE_LINEAR: c_int = 16;
pub const GBM_BO_USE_PROTECTED: c_int = 32;
pub const GBM_BO_USE_FRONT_RENDERING: c_int = 64;
pub const GBM_BO_FIXED_COMPRESSION_DEFAULT: c_int = 128;
pub const GBM_BO_FIXED_COMPRESSION_1BPC: c_int = 256;
pub const GBM_BO_FIXED_COMPRESSION_2BPC: c_int = 384;
pub const GBM_BO_FIXED_COMPRESSION_3BPC: c_int = 512;
pub const GBM_BO_FIXED_COMPRESSION_4BPC: c_int = 640;
pub const GBM_BO_FIXED_COMPRESSION_5BPC: c_int = 768;
pub const GBM_BO_FIXED_COMPRESSION_6BPC: c_int = 896;
pub const GBM_BO_FIXED_COMPRESSION_7BPC: c_int = 1024;
pub const GBM_BO_FIXED_COMPRESSION_8BPC: c_int = 1152;
pub const GBM_BO_FIXED_COMPRESSION_9BPC: c_int = 1280;
pub const GBM_BO_FIXED_COMPRESSION_10BPC: c_int = 1408;
pub const GBM_BO_FIXED_COMPRESSION_11BPC: c_int = 1536;
pub const GBM_BO_FIXED_COMPRESSION_12BPC: c_int = 1664;
pub const enum_gbm_bo_flags = c_uint;
pub extern fn gbm_device_get_fd(gbm: ?*struct_gbm_device) c_int;
pub extern fn gbm_device_get_backend_name(gbm: ?*struct_gbm_device) [*c]const u8;
pub extern fn gbm_device_is_format_supported(gbm: ?*struct_gbm_device, format: u32, flags: u32) c_int;
pub extern fn gbm_device_get_format_modifier_plane_count(gbm: ?*struct_gbm_device, format: u32, modifier: u64) c_int;
pub extern fn gbm_device_destroy(gbm: ?*struct_gbm_device) void;
pub extern fn gbm_create_device(fd: c_int) ?*struct_gbm_device;
pub extern fn gbm_bo_create(gbm: ?*struct_gbm_device, width: u32, height: u32, format: u32, flags: u32) ?*struct_gbm_bo;
pub extern fn gbm_bo_create_with_modifiers(gbm: ?*struct_gbm_device, width: u32, height: u32, format: u32, modifiers: [*c]const u64, count: c_uint) ?*struct_gbm_bo;
pub extern fn gbm_bo_create_with_modifiers2(gbm: ?*struct_gbm_device, width: u32, height: u32, format: u32, modifiers: [*c]const u64, count: c_uint, flags: u32) ?*struct_gbm_bo;
pub const struct_gbm_import_fd_data = extern struct {
    fd: c_int = @import("std").mem.zeroes(c_int),
    width: u32 = @import("std").mem.zeroes(u32),
    height: u32 = @import("std").mem.zeroes(u32),
...
pub const struct_gbm_import_fd_modifier_data = extern struct {
    width: u32 = @import("std").mem.zeroes(u32),
    height: u32 = @import("std").mem.zeroes(u32),
    format: u32 = @import("std").mem.zeroes(u32),
    num_fds: u32 = @import("std").mem.zeroes(u32),
    fds: [4]c_int = @import("std").mem.zeroes([4]c_int),
    strides: [4]c_int = @import("std").mem.zeroes([4]c_int),
    offsets: [4]c_int = @import("std").mem.zeroes([4]c_int),
    modifier: u64 = @import("std").mem.zeroes(u64),
};
pub extern fn gbm_bo_import(gbm: ?*struct_gbm_device, @"type": u32, buffer: ?*anyopaque, flags: u32) ?*struct_gbm_bo;
pub const GBM_BO_TRANSFER_READ: c_int = 1;
pub const GBM_BO_TRANSFER_WRITE: c_int = 2;
pub const GBM_BO_TRANSFER_READ_WRITE: c_int = 3;
pub const enum_gbm_bo_transfer_flags = c_uint;
pub extern fn gbm_bo_map(bo: ?*struct_gbm_bo, x: u32, y: u32, width: u32, height: u32, flags: u32, stride: [*c]u32, map_data: [*c]?*anyopaque) ?*anyopaque;
pub extern fn gbm_bo_unmap(bo: ?*struct_gbm_bo, map_data: ?*anyopaque) void;
pub extern fn gbm_bo_get_width(bo: ?*struct_gbm_bo) u32;
pub extern fn gbm_bo_get_height(bo: ?*struct_gbm_bo) u32;
pub extern fn gbm_bo_get_stride(bo: ?*struct_gbm_bo) u32;
pub extern fn gbm_bo_get_stride_for_plane(bo: ?*struct_gbm_bo, plane: c_int) u32;
pub extern fn gbm_bo_get_format(bo: ?*struct_gbm_bo) u32;
pub extern fn gbm_bo_get_bpp(bo: ?*struct_gbm_bo) u32;
pub extern fn gbm_bo_get_offset(bo: ?*struct_gbm_bo, plane: c_int) u32;
pub extern fn gbm_bo_get_device(bo: ?*struct_gbm_bo) ?*struct_gbm_device;
pub extern fn gbm_bo_get_handle(bo: ?*struct_gbm_bo) union_gbm_bo_handle;
pub extern fn gbm_bo_get_fd(bo: ?*struct_gbm_bo) c_int;
pub extern fn gbm_bo_get_modifier(bo: ?*struct_gbm_bo) u64;
pub extern fn gbm_bo_get_plane_count(bo: ?*struct_gbm_bo) c_int;
pub extern fn gbm_bo_get_handle_for_plane(bo: ?*struct_gbm_bo, plane: c_int) union_gbm_bo_handle;
pub extern fn gbm_bo_get_fd_for_plane(bo: ?*struct_gbm_bo, plane: c_int) c_int;
pub extern fn gbm_bo_write(bo: ?*struct_gbm_bo, buf: ?*const anyopaque, count: usize) c_int;
pub extern fn gbm_bo_set_user_data(bo: ?*struct_gbm_bo, data: ?*anyopaque, destroy_user_data: ?*const fn (?*struct_gbm_bo, ?*anyopaque) callconv(.c) void) void;
pub extern fn gbm_bo_get_user_data(bo: ?*struct_gbm_bo) ?*anyopaque;
pub extern fn gbm_bo_destroy(bo: ?*struct_gbm_bo) void;
pub extern fn gbm_surface_create(gbm: ?*struct_gbm_device, width: u32, height: u32, format: u32, flags: u32) ?*struct_gbm_surface;
pub extern fn gbm_surface_create_with_modifiers(gbm: ?*struct_gbm_device, width: u32, height: u32, format: u32, modifiers: [*c]const u64, count: c_uint) ?*struct_gbm_surface;
pub extern fn gbm_surface_create_with_modifiers2(gbm: ?*struct_gbm_device, width: u32, height: u32, format: u32, modifiers: [*c]const u64, count: c_uint, flags: u32) ?*struct_gbm_surface;
pub extern fn gbm_surface_lock_front_buffer(surface: ?*struct_gbm_surface) ?*struct_gbm_bo;
pub extern fn gbm_surface_release_buffer(surface: ?*struct_gbm_surface, bo: ?*struct_gbm_bo) void;
pub extern fn gbm_surface_has_free_buffers(surface: ?*struct_gbm_surface) c_int;
pub extern fn gbm_surface_destroy(surface: ?*struct_gbm_surface) void;
pub extern fn gbm_format_get_name(gbm_format: u32, desc: [*c]struct_gbm_format_name_desc) [*c]u8;
...
pub const _GBM_H_ = "";
pub const __GBM__ = @as(c_int, 1);
pub inline fn __gbm_fourcc_code(a: anytype, b: anytype, c: anytype, d: anytype) @TypeOf(((@import("std").zig.c_translation.cast(u32, a) | (@import("std").zig.c_translation.cast(u32, b) << @as(c_int, 8))) | (@import("std").zig.c_translation.cast(u32, c) << @as(c_int, 16))) | (@import("std").zig.c_translation.cast(u32, d) << @as(c_int, 24))) {
    _ = &a;
    _ = &b;
    _ = &c;
    _ = &d;
    return ((@import("std").zig.c_translation.cast(u32, a) | (@import("std").zig.c_translation.cast(u32, b) << @as(c_int, 8))) | (@import("std").zig.c_translation.cast(u32, c) << @as(c_int, 16))) | (@import("std").zig.c_translation.cast(u32, d) << @as(c_int, 24));
}
pub const GBM_FORMAT_BIG_ENDIAN = @as(c_int, 1) << @as(c_int, 31);
pub const GBM_FORMAT_C8 = __gbm_fourcc_code('C', '8', ' ', ' ');
pub const GBM_FORMAT_R8 = __gbm_fourcc_code('R', '8', ' ', ' ');
pub const GBM_FORMAT_R16 = __gbm_fourcc_code('R', '1', '6', ' ');
pub const GBM_FORMAT_GR88 = __gbm_fourcc_code('G', 'R', '8', '8');
pub const GBM_FORMAT_RG1616 = __gbm_fourcc_code('R', 'G', '3', '2');
pub const GBM_FORMAT_GR1616 = __gbm_fourcc_code('G', 'R', '3', '2');
pub const GBM_FORMAT_RGB332 = __gbm_fourcc_code('R', 'G', 'B', '8');
pub const GBM_FORMAT_BGR233 = __gbm_fourcc_code('B', 'G', 'R', '8');
pub const GBM_FORMAT_XRGB4444 = __gbm_fourcc_code('X', 'R', '1', '2');
pub const GBM_FORMAT_XBGR4444 = __gbm_fourcc_code('X', 'B', '1', '2');
pub const GBM_FORMAT_RGBX4444 = __gbm_fourcc_code('R', 'X', '1', '2');
pub const GBM_FORMAT_BGRX4444 = __gbm_fourcc_code('B', 'X', '1', '2');
pub const GBM_FORMAT_ARGB4444 = __gbm_fourcc_code('A', 'R', '1', '2');
pub const GBM_FORMAT_ABGR4444 = __gbm_fourcc_code('A', 'B', '1', '2');
pub const GBM_FORMAT_RGBA4444 = __gbm_fourcc_code('R', 'A', '1', '2');
pub const GBM_FORMAT_BGRA4444 = __gbm_fourcc_code('B', 'A', '1', '2');
pub const GBM_FORMAT_XRGB1555 = __gbm_fourcc_code('X', 'R', '1', '5');
pub const GBM_FORMAT_XBGR1555 = __gbm_fourcc_code('X', 'B', '1', '5');
pub const GBM_FORMAT_RGBX5551 = __gbm_fourcc_code('R', 'X', '1', '5');
pub const GBM_FORMAT_BGRX5551 = __gbm_fourcc_code('B', 'X', '1', '5');
pub const GBM_FORMAT_ARGB1555 = __gbm_fourcc_code('A', 'R', '1', '5');
pub const GBM_FORMAT_ABGR1555 = __gbm_fourcc_code('A', 'B', '1', '5');
pub const GBM_FORMAT_RGBA5551 = __gbm_fourcc_code('R', 'A', '1', '5');
pub const GBM_FORMAT_BGRA5551 = __gbm_fourcc_code('B', 'A', '1', '5');
pub const GBM_FORMAT_RGB565 = __gbm_fourcc_code('R', 'G', '1', '6');
pub const GBM_FORMAT_BGR565 = __gbm_fourcc_code('B', 'G', '1', '6');
pub const GBM_FORMAT_RGB888 = __gbm_fourcc_code('R', 'G', '2', '4');
pub const GBM_FORMAT_BGR888 = __gbm_fourcc_code('B', 'G', '2', '4');
pub const GBM_FORMAT_XRGB8888 = __gbm_fourcc_code('X', 'R', '2', '4');
pub const GBM_FORMAT_XBGR8888 = __gbm_fourcc_code('X', 'B', '2', '4');
pub const GBM_FORMAT_RGBX8888 = __gbm_fourcc_code('R', 'X', '2', '4');
pub const GBM_FORMAT_BGRX8888 = __gbm_fourcc_code('B', 'X', '2', '4');
pub const GBM_FORMAT_ARGB8888 = __gbm_fourcc_code('A', 'R', '2', '4');
pub const GBM_FORMAT_ABGR8888 = __gbm_fourcc_code('A', 'B', '2', '4');
pub const GBM_FORMAT_RGBA8888 = __gbm_fourcc_code('R', 'A', '2', '4');
pub const GBM_FORMAT_BGRA8888 = __gbm_fourcc_code('B', 'A', '2', '4');
pub const GBM_FORMAT_XRGB2101010 = __gbm_fourcc_code('X', 'R', '3', '0');
pub const GBM_FORMAT_XBGR2101010 = __gbm_fourcc_code('X', 'B', '3', '0');
pub const GBM_FORMAT_RGBX1010102 = __gbm_fourcc_code('R', 'X', '3', '0');
pub const GBM_FORMAT_BGRX1010102 = __gbm_fourcc_code('B', 'X', '3', '0');
pub const GBM_FORMAT_ARGB2101010 = __gbm_fourcc_code('A', 'R', '3', '0');
pub const GBM_FORMAT_ABGR2101010 = __gbm_fourcc_code('A', 'B', '3', '0');
pub const GBM_FORMAT_RGBA1010102 = __gbm_fourcc_code('R', 'A', '3', '0');
pub const GBM_FORMAT_BGRA1010102 = __gbm_fourcc_code('B', 'A', '3', '0');
pub const GBM_FORMAT_XBGR16161616 = __gbm_fourcc_code('X', 'B', '4', '8');
pub const GBM_FORMAT_ABGR16161616 = __gbm_fourcc_code('A', 'B', '4', '8');
pub const GBM_FORMAT_XBGR16161616F = __gbm_fourcc_code('X', 'B', '4', 'H');
pub const GBM_FORMAT_ABGR16161616F = __gbm_fourcc_code('A', 'B', '4', 'H');
pub const GBM_FORMAT_YUYV = __gbm_fourcc_code('Y', 'U', 'Y', 'V');
pub const GBM_FORMAT_YVYU = __gbm_fourcc_code('Y', 'V', 'Y', 'U');
pub const GBM_FORMAT_UYVY = __gbm_fourcc_code('U', 'Y', 'V', 'Y');
pub const GBM_FORMAT_VYUY = __gbm_fourcc_code('V', 'Y', 'U', 'Y');
pub const GBM_FORMAT_AYUV = __gbm_fourcc_code('A', 'Y', 'U', 'V');
pub const GBM_FORMAT_NV12 = __gbm_fourcc_code('N', 'V', '1', '2');
pub const GBM_FORMAT_NV21 = __gbm_fourcc_code('N', 'V', '2', '1');
pub const GBM_FORMAT_NV16 = __gbm_fourcc_code('N', 'V', '1', '6');
pub const GBM_FORMAT_NV61 = __gbm_fourcc_code('N', 'V', '6', '1');
pub const GBM_FORMAT_YUV410 = __gbm_fourcc_code('Y', 'U', 'V', '9');
pub const GBM_FORMAT_YVU410 = __gbm_fourcc_code('Y', 'V', 'U', '9');
pub const GBM_FORMAT_YUV411 = __gbm_fourcc_code('Y', 'U', '1', '1');
pub const GBM_FORMAT_YVU411 = __gbm_fourcc_code('Y', 'V', '1', '1');
pub const GBM_FORMAT_YUV420 = __gbm_fourcc_code('Y', 'U', '1', '2');
pub const GBM_FORMAT_YVU420 = __gbm_fourcc_code('Y', 'V', '1', '2');
pub const GBM_FORMAT_YUV422 = __gbm_fourcc_code('Y', 'U', '1', '6');
pub const GBM_FORMAT_YVU422 = __gbm_fourcc_code('Y', 'V', '1', '6');
pub const GBM_FORMAT_YUV444 = __gbm_fourcc_code('Y', 'U', '2', '4');
pub const GBM_FORMAT_YVU444 = __gbm_fourcc_code('Y', 'V', '2', '4');
pub const GBM_BO_FIXED_COMPRESSION_MASK = ((@as(c_int, 1) << @as(c_int, 11)) - @as(c_int, 1)) & ~((@as(c_int, 1) << @as(c_int, 7)) - @as(c_int, 1));
pub const GBM_BO_IMPORT_WL_BUFFER = @as(c_int, 0x5501);
pub const GBM_BO_IMPORT_EGL_IMAGE = @as(c_int, 0x5502);
pub const GBM_BO_IMPORT_FD = @as(c_int, 0x5503);
pub const GBM_BO_IMPORT_FD_MODIFIER = @as(c_int, 0x5504);
pub const GBM_MAX_PLANES = @as(c_int, 4);
...
pub const gbm_device = struct_gbm_device;
pub const gbm_bo = struct_gbm_bo;
pub const gbm_surface = struct_gbm_surface;
pub const gbm_bo_handle = union_gbm_bo_handle;
pub const gbm_bo_format = enum_gbm_bo_format;
pub const gbm_format_name_desc = struct_gbm_format_name_desc;
pub const gbm_bo_flags = enum_gbm_bo_flags;
pub const gbm_import_fd_data = struct_gbm_import_fd_data;
pub const gbm_import_fd_modifier_data = struct_gbm_import_fd_modifier_data;
pub const gbm_bo_transfer_flags = enum_gbm_bo_transfer_flags;
